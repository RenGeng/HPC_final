...
void parse_args(int argc, char **argv) {
  ...
  desc.add_options()
    ...
    ("global_size_x,x", po::value<int>()->default_value(256), "Size of the first dimension of the domain")
    ("global_size_y,y", po::value<int>()->default_value(256), "Size of the second dimension of the domain")
  ...
  global_size_x = vars["global_size_x"].as<int>();
  global_size_y = vars["global_size_y"].as<int>();
